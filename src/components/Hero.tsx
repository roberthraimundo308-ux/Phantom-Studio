...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative h-svh flex flex-col justify-end px-6 md:px-[52px] pb-[80px] overflow-hidden">
      <canvas ref={canvasRef} className="absolute inset-0 pointer-events-none opacity-50" />
      
      <div className="relative z-10">
        <div className="font-mono text-[10px] tracking-[0.32em] text-muted uppercase mb-[32px] flex items-center gap-[14px] animate-[fdUp_0.8s_0.2s_forwards] opacity-0 before:content-[''] before:w-7 before:h-[1px] before:bg-muted">
          Estúdio Digital · Experiências que Convertem
        </div>

        <h1 className="font-display text-[clamp(68px,11.5vw,172px)] leading-[1.0] tracking-[-0.01em]">
        ...
        <div className="mt-14 flex items-end justify-between flex-wrap gap-7">
