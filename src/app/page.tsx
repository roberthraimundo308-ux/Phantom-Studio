                ...
                >
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-10">
                    <div className="flex-1">
                      ...
                      <div className="font-headline text-4xl md:text-6xl tracking-[-0.01em] mb-4 text-[#050505] uppercase">{plan.name}</div>
                      <div className="font-headline text-5xl md:text-7xl leading-none text-[#050505]"><small className="text-lg text-[#050505]/30 align-middle mr-1">R$</small>{plan.price}</div>
                      <div className="font-mono text-[10px] tracking-[0.16em] text-[#050505]/30 mt-2 uppercase">Pagamento Único</div>
                    </div>
                    
                    <div className="flex-1">
                      <ul className="list-none flex flex-col gap-3.5 mb-10">
                        {plan.feat.map((f, fIdx) => (
                          <li key={fIdx} className="font-body text-[clamp(14px,1.5vw,16px)] leading-tight text-[#050505]/60 flex gap-3 items-start before:content-['→'] before:text-accent before:shrink-0">
                            {f}
                          </li>
                        ))}
                      </ul>
                      <a 
                        ...
                        className="w-full md:w-auto inline-flex items-center justify-center bg-black text-white font-mono text-[10px] tracking-[0.22em] uppercase px-8 py-4 gap-2 transition-all duration-300 group hover:gap-4 hover:bg-accent hover:text-black"
                      >
